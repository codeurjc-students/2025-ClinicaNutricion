    ...
    return (
        <Modal show={show} onHide={onClose} centered size="lg">
            <Modal.Header closeButton>
                <Modal.Title className="text-success text-align">Crear Nueva Cita</Modal.Title>
            </Modal.Header>
            <Modal.Body>
            <p className="appointment-text">
                    Selecciona un paciente para la cita programada el <strong>
                    {moment(selectedTime).format("DD/MM/YYYY")}</strong> a las <strong>{moment(selectedTime).format("HH:mm")}
                    </strong>.
                </p>
